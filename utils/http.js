                ...
                wx.uploadFile({
                    ...
                    complete() {
                        ...
                        if (FAIL != 0 && _IDX == 0) {
                            wx.showModal({
                                title: "提示",
                                content: fileUrl.length == 1 ?
                                    "图片上传失败" : `共有${FAIL}张图片上传失败，请重新上传`,
                                showCancel: false
                            });
                        }
                        if (_IDX == 0)
